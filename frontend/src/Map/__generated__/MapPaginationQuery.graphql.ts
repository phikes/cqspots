...
export type MapPaginationQuery$variables = {
  count?: number | null | undefined;
  cursor?: string | null | undefined;
};
export type MapPaginationQuery$data = {
  readonly " $fragmentSpreads": FragmentRefs<"MapQueryFragment">;
};
export type MapPaginationQuery = {
  response: MapPaginationQuery$data;
  variables: MapPaginationQuery$variables;
};
